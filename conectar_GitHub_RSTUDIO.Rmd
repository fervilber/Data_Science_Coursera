...
![Trabajar con Git en RSTUDIO](imag/github_rstudio_03.png)

Para subir un cambio al almacén web (GitHub) debemos hacer un **pull request** es decir proponer qué ficheros se van a actualizar, eso se hace pinchando directamente sobre el nombre del fichero en la ventana de Git.

![Subir o actualizar cambios](imag/github_rstudio_03.png)
...
Pasa subir definitvamente los fichero con los cambios debemos pinchar en la flecha hacia arriba de la ventana de Git (control de versiones) en RSTUDIO.